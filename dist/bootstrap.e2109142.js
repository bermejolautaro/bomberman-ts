...
var GameMap = /** @class */function () {
  ...
  GameMap.generateMap = function (rows, columns) {
    ...
    [1, 1], [2, 1], [1, 2],
    // Top Right
    [columns - 2, 1], [columns - 3, 1], [columns - 2, 2],
    // Bottom Left
...
var BombermanGame = /** @class */function (_super) {
      ...
      return __generator(this, function (_e) {
        switch (_e.label) {
          case 0:
            ...
            return [4 /*yield*/, (0, image_utils_1.loadImageFromUrl)('sprites/bomberman-tileset.png')];
          case 1:
            tileset = _e.sent();
            ...
            return [4 /*yield*/, (0, image_utils_1.loadImageFromUrl)('sprites/bomberman-atlas.png')];
          case 2:
...
var WindowDomGameLoop = /** @class */function () {
...
bootstrap();
},{"./bomberman-game":"bomberman-game.ts","./engine/collision-manager":"engine/collision-manager.ts","./engine/entity-manager":"engine/entity-manager.ts","./engine/game-loop":"engine/game-loop.ts","./engine/key-listener":"engine/key-listener.ts","./engine/position-manager":"engine/position-manager.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "10368" + '/');
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","bootstrap.ts"], null)
